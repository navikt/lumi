...
`lumi-api` exposes operational endpoints under `/internal`:
...
NOTE: `lumi-api` does not currently use Rapids & Rivers / Kafka. Keep this section as reference only if Kafka is explicitly introduced.
